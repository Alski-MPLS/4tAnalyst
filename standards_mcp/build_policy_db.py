...
POLICY_FILES = [
    "NSS CIP-H OT only domain.csv",
    "NSS CIP-H.csv",
    "NSS Gas To or From IT and Internet.csv",
    "NSS Inbound.csv",
    "NSS OT and CIP-H To and From Internet and IT.csv",
    "NSS OT and CIPH to_from Internet and IT OT domain only.csv",
]
